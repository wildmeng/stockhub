...
class PanAndZoom(ZoomOnWheel):
    ...
    def __init__(self, figure=None, scale_factor=1.1):
        ...
        self._key_ctrl = False
        self._key_shift = False
        figure.canvas.mpl_connect('key_press_event', self._key_press)
        figure.canvas.mpl_connect('key_release_event', self._key_release)
